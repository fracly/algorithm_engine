    ...
    export default {
        ...
        methods: {
            show (taskInstId) {
                ...
                this.visible = true
                this.spinning = true
                logdetail({ 'taskInstId': taskInstId, 'skipLineNum': 0, 'limit': 10000 }).then(res => {
                    this.spinning = false
                    if (res.data === null) {
                        this.log = '暂无日志'
                    } else {
            ...
            loadLog () {
                this.spinning = true
                logdetail({ 'taskInstId': this.taskInstId, 'skipLineNum': 0, 'limit': 10000 }).then(res => {
                    this.spinning = false
                    if (res.data === null) {
                        this.log = '暂无日志'
                    } else {
