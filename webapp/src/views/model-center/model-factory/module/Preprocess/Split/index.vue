<template>
  <a-form-model layout="vertical" class="ant-advanced-search-form" :model="params">
    ...
    <a-form-item label="拆分比例:">
        <a-input v-model="params.fraction"/>
    </a-form-item>
    <a-form-item style="text-align:center">
      <span style="color: red">*拆分比例为左侧锚点输出数据集</span>
    </a-form-item>
    ...
    methods: {
      ...
      initPage() {
        ...
        if(JSON.stringify(this.tasks)!='{}'){
          ...
          let localNodeTableName = this.$parent.getLocalNodeTableName()
          this.params.newTable1 = localNodeTableName+"_1"
          this.params.newTable2 =  localNodeTableName+"_2"
        }
        //////////////******************************//自己需要清理的数据
