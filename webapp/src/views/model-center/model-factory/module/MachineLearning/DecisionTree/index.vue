<template>
  <a-form-model layout="vertical" class="ant-advanced-search-form" :model="params">
    <a-form-item label="节点最大分支:" :label-col="labelCol" :wrapper-col="wrapperCol">
      <a-input v-model="params.branchMax" />
    </a-form-item>
    <a-form-item label="最大深度:" :label-col="labelCol" :wrapper-col="wrapperCol">
      <a-input v-model="params.depthMax"/>
    </a-form-item>
    <a-form-item label="分裂节点的方法:" :label-col="labelCol" :wrapper-col="wrapperCol">
      <a-select  v-model="params.method" :defaultValue="params.condition" style="width: 100px">
        <a-select-option key="1" value="gini">gini</a-select-option>
        <a-select-option key="2" value="entropy">entropy</a-select-option>
      </a-select>
    </a-form-item>
