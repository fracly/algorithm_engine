<template>
  ...
  >
    <a-spin :spinning="confirmLoading">
      <a-table
        ...
        <template slot="type" slot-scope="text, record">
          <a-select show-search optionFilterProp="children" v-if="record.editable" style="width:100px;" @change="handleChange($event, '', 'type', record.id)" v-model="record.type">
        ...
        <template slot="operation" slot-scope="text, record">
          <div v-if="userInfo.administrator" class="editable-row-operations">
    ...
    <a-button v-show="userInfo.administrator" style="margin-top: 10px" @click="handleAdd" type="primary">添加字段</a-button>
