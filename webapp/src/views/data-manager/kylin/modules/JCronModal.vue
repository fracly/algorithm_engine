...
<!--            </a-row>-->
            <a-row>
              <a-radio value="3">具体秒数</a-radio>
              <a-select style="width:354px;" size="small" v-model="result.second.specificSpecific">
...
<!--              </a-row>-->
              <a-row>
                <a-radio value="3">具体分钟数</a-radio>
                <a-select style="width:340px;" size="small"  v-model="result.minute.specificSpecific">
...
<!--              </a-row>-->
              <a-row>
                <a-radio class="long" value="3">具体小时数</a-radio>
                <a-select style="width:340px;" size="small"  v-model="result.hour.specificSpecific">
...
<!--              </a-row>-->
              ...
              <a-row>
                <a-radio class="long" value="4">具体星期几</a-radio>
                <a-select style="width:340px;" size="small"  v-model="result.week.specificSpecific">
                  <a-select-option v-for="(val,index) in Array(7)" :key="index" :value="index+1">{{ weekDays[index] }}</a-select-option>
                </a-select>
              </a-row>
              <a-row>
                <a-radio class="long" value="5">具体天数</a-radio>
                <a-select style="width:354px;" size="small"  v-model="result.day.specificSpecific">
...
<!--                    <a-select-option v-for="(val,index) in Array(7)" :key="index+1" :value="index+1">{{ weekDays[index] }}</a-select-option>-->
<!--                  </a-select>-->
            ...
            secondsText () {
                ...
                switch (cronEvery.toString()) {
                    ...
                    case '3':
                        ...
                        seconds = this.result.second.specificSpecific.toString()
                        break
                    case '4':
            ...
            minutesText () {
                ...
                switch (cronEvery.toString()) {
                    ...
                    case '3':
                        ...
                        minutes = this.result.minute.specificSpecific.toString()
                        break
                    case '4':
            ...
            hoursText () {
                ...
                switch (cronEvery.toString()) {
                    ...
                    case '3':
                        ...
                        hours = this.result.hour.specificSpecific.toString()
                        break
                    case '4':
            ...
            daysText () {
                ...
                switch (cronEvery.toString()) {
                    ...
                    case '5':
                        ...
                        // })
                        // days = days.slice(0, -1)
                      days = this.result.day.specificSpecific.toString()
                      break
                    case '6':
                        days = 'L'
                        break
            ...
            weeksText () {
                ...
                switch (cronEvery.toString()) {
                    ...
                    case '4':
                        ...
                        weeks = this.result.week.specificSpecific.toString()
                        break
                    case '6':
                    case '7':
                    case '8':
            ...
            daysReverseExp (cron) {
                ...
                if (!days.includes('?')) {
                    ...
                    switch (true) {
                        case weeks.includes('/'):
                            day.cronEvery = '2'
                            week.incrementStart = Number(weeks.split('/')[0])
                            week.incrementIncrement = Number(weeks.split('/')[1])
                            break
                        case weeks.includes(','):
                            day.cronEvery = '4'
