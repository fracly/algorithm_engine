  ...
  public static BaseDataSource getDatasource(DbType dbType, String parameter) {
    try {
      switch (dbType) {
        ...
        case KAFKA:
          return JSONUtils.parseObject(parameter, KafkaDataSource.class);
        case ELASTICSEARCH:
          return JSONUtils.parseObject(parameter, ElasticsearchDataSource.class);
        case KYLIN:
          return JSONUtils.parseObject(parameter, KylinDataSource.class);
        default:
          return null;
      }
    } catch (Exception e) {
