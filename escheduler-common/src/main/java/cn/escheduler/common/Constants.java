...
public final class Constants {
    ...
    /**
     * application master properties path
     */
    public static final String APPLICATION_MASTER_PROPERTIES_PATH = "application_master.properties";

    /**
     * application master url
     */
    public static final String APPLICATION_MASTER_URL = "master_url";
    ...
    /**
     * exit code param error
     */
    public static final int EXIT_CODE_PARMAS_ERROR = -2;
    /**
