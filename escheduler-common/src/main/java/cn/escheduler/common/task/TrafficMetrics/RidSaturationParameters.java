 ...
 * @version:
 */
public class RidSaturationParameters extends SparkParameters {
    /**
     * databases
     */
    ...
    public int getDatasource3() {
        return datasource3;
    }

    public void setDatasource3(int datasource3) {
