...
# mysql配置
# mysql 地址,端口
mysqlHost="10.20.10.173:3306"

# mysql 数据库名称
mysqlDb="algorithm_engine"
...
installPath="/opt/algorithm_engine"
...
# zk集群
zkQuorum="10.20.10.171:2181,10.20.10.172:2181,10.20.10.173:2181"
...
masters="10.20.10.172"

# 运行Worker的机器
# 注意：部署worker的机器hostname列表
workers="10.20.10.172"

# 运行Alert的机器
# 注意：部署alert server的机器hostname列表
alertServer="10.20.10.172"

# 运行Api的机器
# 注意：部署api server的机器hostname列表
apiServers="10.20.10.172"
...
namenodeFs="hdfs://10.20.10.171:8020"

# resourcemanager HA配置，如果是单resourcemanager,这里为空即可
yarnHaIps="10.20.10.171"

# 如果是单 resourcemanager,只需要配置一个主机名称,如果是resourcemanager HA,则默认配置就好
singleYarnIp="10.20.10.171"
