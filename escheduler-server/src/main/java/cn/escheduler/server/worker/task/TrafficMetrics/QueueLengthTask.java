 ...
 * @version:
 */
public class QueueLengthTask extends AbstractYarnTask {
    /**
     * @param taskProps
     * @param logger
     * 去重列
     */
    public QueueLengthTask(TaskProps taskProps, Logger logger) {
    ...
    private QueueLengthParameters queueLengthParametersters;
    ...
    public void init() {
        ...
        queueLengthParametersters = JSONUtils.parseObject(taskProps.getTaskParams(), QueueLengthParameters.class);
    ...
    protected String buildCommand()   {
        ...
        String command = "spark-submit  " +
                "--class " + "com.bcht.algorithms.engine.QueueLength" + " " +
    ...
    public boolean checkParams() {
        ...
        try {
            this.queueLengthParametersters = JSONObject.parseObject(taskParams, QueueLengthParameters.class);
        }catch (Exception e){
