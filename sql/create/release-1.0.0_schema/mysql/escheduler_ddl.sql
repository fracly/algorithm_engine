...
CREATE TABLE `t_escheduler_project` (
  ...
  `type` int(11) DEFAULT NULL COMMENT '1代表ETL，默认为空代表模型中心',
  PRIMARY KEY (`id`),
...
CREATE TABLE `t_escheduler_task_instance` (
  ...
  `result_table` varchar(255) DEFAULT NULL COMMENT '结果表名',
  PRIMARY KEY (`id`),
...
-- ----------------------------
-- Table structure for t_escheduler_colruleconf
-- ----------------------------
DROP TABLE IF EXISTS `t_escheduler_colruleconf`;
CREATE TABLE `t_escheduler_colruleconf` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `type` varchar(64) NOT NULL COMMENT '规则类型',
  `condi` varchar(256) NOT NULL COMMENT '规则条件',
  `param` varchar(256) DEFAULT NULL COMMENT '参数',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Table structure for `t_escheduler_dataasset`
-- ----------------------------
DROP TABLE IF EXISTS `t_escheduler_dataasset`;
CREATE TABLE `t_escheduler_dataasset` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Table structure for `t_escheduler_dataasset_label`
-- ----------------------------
DROP TABLE IF EXISTS `t_escheduler_dataasset_label`;
CREATE TABLE `t_escheduler_dataasset_label` (
  `id` int(11) NOT NULL,
  `name` varchar(255) DEFAULT NULL,
  `create_time` datetime DEFAULT NULL,
  `update_time` datetime DEFAULT NULL,
...
-- ----------------------------
-- Table structure for `t_escheduler_dataasset_rule`
-- ----------------------------
DROP TABLE IF EXISTS `t_escheduler_dataasset_rule`;
CREATE TABLE `t_escheduler_dataasset_rule` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `asset_id` int(11) DEFAULT NULL,
  `destroy_method` varchar(255) DEFAULT NULL,
  `destroy_period` int(11) DEFAULT NULL,
  `create_time` datetime DEFAULT NULL,
  `update_time` datetime DEFAULT NULL,
...
-- ----------------------------
-- Table structure for `t_escheduler_dataasset_type`
-- ----------------------------
DROP TABLE IF EXISTS `t_escheduler_dataasset_type`;
CREATE TABLE `t_escheduler_dataasset_type` (
  `id` int(11) NOT NULL,
  `name` varchar(255) DEFAULT NULL,
...
-- ----------------------------
-- Table structure for `t_escheduler_hivesize`
-- ----------------------------
DROP TABLE IF EXISTS `t_escheduler_hivesize`;
CREATE TABLE `t_escheduler_hivesize` (
  `hivesize` double unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`hivesize`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Table structure for `t_escheduler_hivetablesize`
-- ----------------------------
DROP TABLE IF EXISTS `t_escheduler_hivetablesize`;
CREATE TABLE `t_escheduler_hivetablesize` (
  `name` varchar(255) NOT NULL,
  `size` double(50,0) NOT NULL DEFAULT '0',
  PRIMARY KEY (`name`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Table structure for `t_escheduler_model_basename`
-- ----------------------------
DROP TABLE IF EXISTS `t_escheduler_model_basename`;
CREATE TABLE `t_escheduler_model_basename` (
  `base` varchar(64) NOT NULL COMMENT '库',
  `name` varchar(64) NOT NULL COMMENT '库名称'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Table structure for `t_escheduler_model_catalog`
-- ----------------------------
DROP TABLE IF EXISTS `t_escheduler_model_catalog`;
CREATE TABLE `t_escheduler_model_catalog` (
  `base` varchar(64) NOT NULL COMMENT '数据库',
  `layer` varchar(64) NOT NULL COMMENT '分层',
  `id` int(11) NOT NULL,
  PRIMARY KEY (`base`,`layer`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;


-- ----------------------------
-- Table structure for `t_escheduler_model_design`
-- ----------------------------
DROP TABLE IF EXISTS `t_escheduler_model_design`;
CREATE TABLE `t_escheduler_model_design` (
  `base` varchar(64) NOT NULL COMMENT '数据库',
  `layer` varchar(256) NOT NULL COMMENT '业务层',
  `tablename` varchar(256) NOT NULL COMMENT '表名称',
  `tabledescribe` varchar(256) DEFAULT NULL COMMENT '表描述',
  `area` varchar(256) DEFAULT NULL COMMENT '应用领域',
  `tabrule` text COMMENT '表规则（json格式）',
  `colrule` text COMMENT '列规则（json格式）',
  `tabwarn` varchar(11) DEFAULT NULL,
  `tabquality` varchar(11) DEFAULT NULL COMMENT '表质量',
  `datasourceid` int(11) DEFAULT NULL COMMENT 'DataSourceID',
  `type` varchar(64) DEFAULT NULL COMMENT '数据源类型',
  `create_time` datetime DEFAULT NULL,
  `update_time` datetime DEFAULT NULL,
  `create_userid` varchar(255) DEFAULT NULL,
  `username` varchar(255) DEFAULT NULL COMMENT '创建用户',
  PRIMARY KEY (`base`,`tablename`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Table structure for `t_escheduler_rule`
-- ----------------------------
DROP TABLE IF EXISTS `t_escheduler_rule`;
CREATE TABLE `t_escheduler_rule` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `name` varchar(64) NOT NULL COMMENT '数据源名称',
  `tablename` varchar(256) DEFAULT NULL COMMENT '表名称',
  `colname` varchar(256) DEFAULT NULL COMMENT '列名称',
  `type` varchar(256) DEFAULT NULL COMMENT '数据类型',
  `rule` varchar(256) DEFAULT NULL COMMENT '定义规则',
  `warning_value` varchar(256) DEFAULT NULL COMMENT '预警值',
...
-- ----------------------------
-- Table structure for `t_escheduler_schema_branch`
-- ----------------------------
DROP TABLE IF EXISTS `t_escheduler_schema_branch`;
CREATE TABLE `t_escheduler_schema_branch` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) DEFAULT NULL,
  `schema_base` varchar(255) DEFAULT NULL,
...
-- ----------------------------
-- Table structure for `t_escheduler_schema_version`
-- ----------------------------
DROP TABLE IF EXISTS `t_escheduler_schema_version`;
CREATE TABLE `t_escheduler_schema_version` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) DEFAULT NULL,
  ...
  `update_time` datetime DEFAULT NULL,
  `schema_base` varchar(255) DEFAULT NULL,
  `schema_tablename` varchar(255) DEFAULT NULL,
  `branch_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=594 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Table structure for `t_escheduler_tabruleconf`
-- ----------------------------
DROP TABLE IF EXISTS `t_escheduler_tabruleconf`;
CREATE TABLE `t_escheduler_tabruleconf` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `type` varchar(64) NOT NULL COMMENT '规则类型',
  `condi` varchar(256) NOT NULL COMMENT '规则条件',
  `param` varchar(256) DEFAULT NULL COMMENT '参数',
