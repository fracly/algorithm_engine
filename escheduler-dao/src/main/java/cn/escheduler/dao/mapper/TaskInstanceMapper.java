...
public interface TaskInstanceMapper {
    ...
    @Results(value = {@Result(property = "id", column = "id", id = true, javaType = Integer.class, jdbcType = JdbcType.INTEGER),
            ...
            @Result(property = "resultTable", column = "result_table", javaType = String.class, jdbcType = JdbcType.VARCHAR)
    })
     ...
     * @return
     */
    @Results(value = { @Result(property = "appId", column = "appId", javaType = String.class, jdbcType = JdbcType.VARCHAR)
    })
    @SelectProvider(type = TaskInstanceMapperProvider.class, method = "getAppIds")
    List<String> getAppIds(@Param("taskInstanceId") int taskInstanceId);
    ...
    @SelectProvider(type = TaskInstanceMapperProvider.class, method = "findValidTaskListByProcessId2")
    List<TaskInstance> findValidTaskListByProcessId2(@Param("processInstanceId") Integer processInstanceId,
    ...
    @SelectProvider(type = TaskInstanceMapperProvider.class, method = "findValidTaskListByProcessIdIn")
    List<TaskInstance> findValidTaskListByProcessIdIn(@Param("processInstanceId") Integer processInstanceId,
                                                     @Param("taskName") String taskName,
                                                     @Param("flag") Flag flag);
     ...
     * @return
     */
    @SelectProvider(type = TaskInstanceMapperProvider.class, method = "countTaskInstance2")
    Integer countTaskInstance2(@Param("userId") Integer userId,
    ...
    @SelectProvider(type = TaskInstanceMapperProvider.class, method = "queryTaskInstanceListPaging2")
    List<TaskInstance> queryTaskInstanceListPaging2(
    ...
    @SelectProvider(type = TaskInstanceMapperProvider.class, method = "queryByInstanceIdAndName2")
    TaskInstance queryByInstanceIdAndName2(@Param("processInstanceId") int processInstanceId,
                                          @Param("name") String name);
    ...
    @SelectProvider(type = TaskInstanceMapperProvider.class, method = "queryByProcessInstance")
    List<TaskInstance> queryByProcessInstance(@Param("processInstanceId") Long processInstanceId);
}
