...
public interface ScheduleMapper {
   ...
   */
    @Results(value = {
            ...
            @Result(property = "workerGroupId", column = "worker_group_id", javaType = int.class, jdbcType = JdbcType.INTEGER),
            @Result(property = "processInstancePriority", column = "process_instance_priority", javaType = Priority.class, typeHandler = EnumOrdinalTypeHandler.class, jdbcType = JdbcType.TINYINT),
            @Result(property = "cubeName", column = "cube_name", javaType = String.class, jdbcType = JdbcType.VARCHAR),
   ...
   * @return
   */
  @UpdateProvider(type = ScheduleMapperProvider.class, method = "updateWork")
  int updateWork(@Param("definitionId") int definitionId,
  ...
  @SelectProvider(type = ScheduleMapperProvider.class, method = "queryByCubeName")
  List<Schedule> queryByCubeName(@Param("cubeName") String cubeName);
}
