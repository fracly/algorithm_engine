...
public class ScheduleMapperProvider {
  ...
  public String insert(Map<String, Object> parameter) {
    return new SQL() {{
      ...
      VALUES("`cube_name`", "#{schedule.cubeName}");
      VALUES("`type`", "#{schedule.type}");
      VALUES("`time`", "#{schedule.time}");
   ...
   * @return
   */
  public String queryByCubeName(Map<String, Object> parameter) {
  ...
  public String updateWork(Map<String, Object> parameter) {
    return new SQL() {
      {
        UPDATE(DB_NAME);
        SET("`warning_group_id`=#{warningGroupId}");
        SET("`worker_group_id`=#{groupId}");
        SET("`failure_strategy`=" + EnumFieldUtil.genFieldStr("failureStrategy", FailureStrategy.class));
        SET("`warning_type`=" + EnumFieldUtil.genFieldStr("warningType", WarningType.class));
        SET("`process_instance_priority`="+ EnumFieldUtil.genFieldStr("processInstancePriority", Priority.class));
