...
public interface ProcessInstanceMapper {
    ...
    @Results(value = {@Result(property = "id", column = "id", id = true, javaType = Integer.class, jdbcType = JdbcType.INTEGER),
            ...
            @Result(property = "endTime", column = "end_time", javaType = Timestamp.class, jdbcType = JdbcType.DATE),
            @Result(property = "runTimes", column = "run_times", javaType = Integer.class, jdbcType = JdbcType.INTEGER),
            @Result(property = "processDefinitionName", column = "process_definition_name", javaType = String.class, jdbcType = JdbcType.VARCHAR),
            @Result(property = "name", column = "name", javaType = String.class, jdbcType = JdbcType.VARCHAR),
    ...
    @SelectProvider(type = ProcessInstanceMapperProvider.class, method = "queryProcessInstanceListPaging2")
    List<ProcessInstance> queryProcessInstanceListPaging2(
     ...
     * @return
     */
    @SelectProvider(type = ProcessInstanceMapperProvider.class, method = "countProcessInstance2")
    Integer countProcessInstance2(
                                 @Param("userId") Integer userId,
                                 @Param("projectId") Integer projectId,
                                 @Param("processDefinitionId") Integer processDefinitionId,
                                 @Param("states")String statusArray,
    ...
    @SelectProvider(type = ProcessInstanceMapperProvider.class, method = "countProcessAvgRunTimesStatistic")
    Integer countProcessAvgRunTimesStatistic(@Param("startTime") String startTime,
                                             @Param("endTime") String endTime);

    @SelectProvider(type = ProcessInstanceMapperProvider.class, method = "countProcessTodayRunTimesStatistic")
    Integer countProcessTodayRunTimesStatistic(@Param("startTime") String startTime,
                                               @Param("endTime") String endTime,
                                               @Param("userId") Integer userId);

    @SelectProvider(type = ProcessInstanceMapperProvider.class, method = "countProcessTodaySuccessTimesStatistic")
    Integer countProcessTodaySuccessTimesStatistic(@Param("startTime") String startTime,
                                                   @Param("endTime") String endTime,
                                                   @Param("userId") Integer userId);

    @SelectProvider(type = ProcessInstanceMapperProvider.class, method = "countProcessTodayFailedTimesStatistic")
    Integer countProcessTodayFailedTimesStatistic(@Param("startTime") String startTime,
                                                  @Param("endTime") String endTime,
                                                  @Param("userId") Integer userId);
