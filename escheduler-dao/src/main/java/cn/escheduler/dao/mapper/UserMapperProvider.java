...
public class UserMapperProvider {
    ...
    private static final String TABLE_USER_LOGIN = "t_escheduler_user_login";
    ...
    public String incrementErrorCount(Map<String, Object> parameter) {
        return new SQL() {
            {
                UPDATE(TABLE_NAME);
     ...
     * @return
     */
    public String userLogin(Map<String, Object> parameter) {
        return new SQL() {{
            INSERT_INTO(TABLE_USER_LOGIN);
