...
public interface DataSourceMapper {
  ...
  @SelectProvider(type = DataSourceMapperProvider.class, method = "countUserDatasourceBySearch")
  int countUserDatasourceBysearchVal(@Param("userId") int userId,@Param("searchVal") String searchVal);
   ...
   * @return
   */
  @SelectProvider(type = DataSourceMapperProvider.class, method = "countAllDatasourceBySearch")
  int countAllDatasourceBysearchVal(@Param("searchVal") String searchVal);
