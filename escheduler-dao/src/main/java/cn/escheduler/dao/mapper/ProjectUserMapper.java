...
public interface ProjectUserMapper {
   ...
   * @return
   */
  @Results(value = {@Result(property = "id", column = "id", javaType = int.class, jdbcType = JdbcType.INTEGER),
  ...
  @SelectProvider(type = ProjectUserMapperProvider.class, method = "queryDefinition")
  List<Map> queryDefinition(@Param("projectId") int projectId,@Param("state") int state,@Param("userId") Integer userId);
    ...
    @Results(value = {@Result(property = "id", column = "id", javaType = int.class, jdbcType = JdbcType.INTEGER),
            ...
            @Result(property = "desc", column = "desc", javaType = String.class, jdbcType = JdbcType.VARCHAR),
            @Result(property = "projectName", column = "projectName", javaType = String.class, jdbcType = JdbcType.VARCHAR),
            @Result(property = "userId", column = "userId", javaType = int.class, jdbcType = JdbcType.INTEGER),
            @Result(property = "userName", column = "userName", javaType = String.class, jdbcType = JdbcType.VARCHAR),
    })
    @SelectProvider(type = ProjectUserMapperProvider.class, method = "queryFlagDefinition")
    List<Map> queryFlagDefinition();
