...
public interface ResourceMapper {
  ...
  int countResourceNumberByType(@Param("userId") int userId,@Param("type") int type,@Param("searchVal") String searchVal);
  ...
  int countAllResourceNumberByType(@Param("type") int type,@Param("searchVal") String searchVal);
