...
import cn.escheduler.dao.model.SparkConfiguration;
...
public interface SparkConfigurationMapper {
     ...
     * @return
     */
    @InsertProvider(type = SparkConfigurationMapperProvider.class, method = "insert")
    @Options(useGeneratedKeys = true,keyProperty = "sparkConfiguration.id")
    @SelectKey(statement = "SELECT LAST_INSERT_ID()", keyProperty = "sparkConfiguration.id", before = false, resultType = long.class)
    int insert(@Param("sparkConfiguration") SparkConfiguration sparkConfiguration);
     ...
     * @return
     */
    @DeleteProvider(type = SparkConfigurationMapperProvider.class, method = "delete")
    int delete(@Param("sparkConfiguration") int processDefinitionId);
