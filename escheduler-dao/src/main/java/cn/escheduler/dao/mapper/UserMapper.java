...
public interface UserMapper {
    ...
    @UpdateProvider(type = UserMapperProvider.class, method = "updateStatus")
    int updateStatus(@Param("id") Integer id, @Param("status") Integer status);

    @UpdateProvider(type = UserMapperProvider.class, method = "incrementErrorCount")
    int incrementErrorCount(@Param("id") Integer id, @Param("count") Integer count);
    ...
    @Results(value = {@Result(property = "id", column = "id", id = true, javaType = Integer.class, jdbcType = JdbcType.INTEGER),
            ...
            @Result(property = "phone", column = "phone", javaType = String.class, jdbcType = JdbcType.VARCHAR),
            @Result(property = "userType", column = "user_type", typeHandler = EnumOrdinalTypeHandler.class, javaType = UserType.class, jdbcType = JdbcType.TINYINT),
            @Result(property = "errorCount", column = "error_count", javaType = Integer.class, jdbcType = JdbcType.INTEGER),
            @Result(property = "createTime", column = "create_time", javaType = Timestamp.class, jdbcType = JdbcType.DATE),
            @Result(property = "updateTime", column = "update_time", javaType = Timestamp.class, jdbcType = JdbcType.DATE)
    })
     ...
     * insert user login
     */
    @InsertProvider(type = UserMapperProvider.class, method = "userLogin")
    int userLogin(@Param("userId") Integer userId, @Param("userName") String userName, @Param("loginTime") Date loginTime, @Param("loginIP") String loginIP, @Param("status") Integer status);
}
