...
public class ProcessDao extends AbstractBaseDao {
     ...
     * @return
     */
    public List<TaskInstance> findValidTaskListByProcessId2(Integer processInstanceId,String taskName){
        return taskInstanceMapper.findValidTaskListByProcessId2(processInstanceId,taskName, Flag.YES);
    }
     ...
     * @return
     */
    public List<TaskInstance> findValidTaskListByProcessIdIn(Integer processInstanceId,String taskName){
        return taskInstanceMapper.findValidTaskListByProcessIdIn(processInstanceId,taskName, Flag.YES);
    }
    ...
    public void changeTaskState(ExecutionStatus state,
                                Date endTime,
                                int taskInstId, String resultTable) {
        TaskInstance taskInstance = taskInstanceMapper.queryById(taskInstId);
        taskInstance.setState(state);
        taskInstance.setEndTime(endTime);
        taskInstance.setResultTable(resultTable);
        saveTaskInstance(taskInstance);
