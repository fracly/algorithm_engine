...
public class SchedulerService extends BaseService {
    ...
    public Map<String, Object> insertSchedule(User loginUser, String projectName, Integer processDefineId, String schedule, WarningType warningType,
        ...
        Map workMap = processDefinitionMapper.getWorkId(processDefineId);
        ...
        if(workMap!=null){
            workerGroupId = (int) workMap.get("workerGroupId");
            warningType= (WarningType) workMap.get("warningType");
            warningGroupId= (int) workMap.get("warningGroupId");
            failureStrategy= (FailureStrategy) workMap.get("failureStrategy");
            processInstancePriority= (Priority) workMap.get("processInstancePriority");
        }
    ...
    public Map<String, Object> updateSchedule(User loginUser, String projectName, Integer id, String scheduleExpression, WarningType warningType,
        ...
        int processDefinitionId = schedule.getProcessDefinitionId();

        //获取 work分组配置信息
        Map workId = processDefinitionMapper.getWorkId(processDefinitionId);
        ...
        if(workId!=null){
            workerGroupId=(int) workId.get("workerGroupId");
            warningType=(WarningType) workId.get("warningType");
            warningGroupId=(Integer) workId.get("warningGroupId");
            failureStrategy=(FailureStrategy) workId.get("failureStrategy");
