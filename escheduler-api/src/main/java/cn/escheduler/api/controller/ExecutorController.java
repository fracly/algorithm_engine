...
import cn.escheduler.common.utils.YarnUtils;
...
//            if(executeType.equals("STOP")){
//                List<String> appIds = taskInstanceMapper.getAppIds(processInstanceId);
//                logger.info("准备杀死 yarn application 进程:"+appIds.toString());
//                YarnUtils.killJob(appIds);
//            }
            return returnDataList(result);
        } catch (Exception e) {
