...
//    DB_OPERATION_ERROR(10005, "database operation error"),
    ...
    DELETE_PROJECT_ERROR_DEFINES_NOT_NULL(10137, "请先删除模型组和回收站中的模型！"),
    BATCH_DELETE_PROCESS_INSTANCE_BY_IDS_ERROR(10117,"批量删除模型实例失败，ids -> {0}! "),
    GET_DATASOURCE_TABLE_LIST_FAILURE(10139,"获取数据源表列表失败！"),
    UPDATE_REPORT_ERROR(10140,"更新报表功能出错！"),
    UPDATE_STATUS_ERROR(10141,"上下线状态改变失败！"),
    DELETE_REPORT_ERROR(10142,"删除报表功能出错！"),
    CREATE_REPORT_GROUP_ERROR(10143,"创建报表分组功能出错！"),

    CREATE_REPORT_CODE_ERROR(10144,"报表编码 重复"),
    SQL_CODE_ERROR(101451,"sql 语句 获取字段 解析失败"),
    EXCLE_CODE_ERROR(10145,"excle 文件保存失败"),
    SQL_CODE_ERROR_NULL(10146,"sql 语句 解析字段为空"),
    GET_WORK_GROUP_ID_ERROR(10147,"获取模型的 分组id 失败"),
    UPDATE_WORK_GROUP_ID_ERROR(10148,"更新模型的 分组id 失败"),
    QUERY_SERVICE_LIST_PAGING_ERROR(10149,"查询服务分页列表出错！"),
    CREATE_SERVICE_CODE_ERROR(10150,"服务编码 重复"),
    PARAS_SQL_EXCLE_ERROR(10151,"解析sql或者excle出错！"),
    CREATE_SERVER_PARAM_ERROR(10152,"创建或者更新参数出错！"),
    QUERY_SERVICE_CALL_STATIC_ERROR(10153,"查询服务调用统计分页列表出错！"),
    TIME_FORMAT_ERROR(10154,"时间区间格式不正确！"),
    DELETE_LAYRE_NOT_NULL(10155,"先清除此业务分类下所有表！"),
    CREATE_DEF_NAME_EXIST(10156,"创建模型失败！模型名称重复"),
    WORK_ISNULL(10157,"任务目前为空，请添加组件"),
    GROUP_FUNCTION_EXISTS(10158, "报表分组已存在！"),
    GET_CLOUDER_INFO_ERROR(10159, "获取集群信息失败！"),
    FILE_NAME_EXISTS(10160, "文件名重复！"),
    ROLE_ID_IS_NULL(10161, "role id 不能为空！"),
    REPORT_CODE_ERROR(10162,"报表编码不存在"),
    ADD_REPORT_USE_COUNT_ERROR(10163,"调用报表次数出错！"),
    GET_CUBE_INFO_ERROR(10164, "获取CUBE信息失败！"),
    SCHEDUER_ERROR_EXIST(10165, "调度任务重复"),
    SCHEDUER_ERROR_NOT_EXIST(10166, "调度任务不存在"),
...
//    RESOURCE_EMPTY(20003, "resource file is empty"),
    ...
    SERVICEENCAPSULA_LIST_ERROR(10001,"加载服务封装列表失败"),
    SERVICEENCAPSULA_ADD_ERROR(10002,"服务封装新增失败"),
    SERVICEENCAPSULA_UPDATE_ERROR(10003,"服务封装更新失败"),
    SERVICEENCAPSULA_DELETE_ERROR(10004,"服务封装删除失败"),
    SERVICEENCAPSULA_TRANSFER_ERROR(10005,"服务封装服务调用失败");
